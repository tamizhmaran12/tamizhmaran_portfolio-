...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "NLP & Large Language Models (LLMs)", level: 95, icon: Brain, color: "text-cyan-400" },
    { name: "Generative AI & RAG (FAISS)", level: 92, icon: Sparkles, color: "text-purple-400" },
    { name: "LangChain & AI Agents", level: 90, icon: Workflow, color: "text-emerald-400" },
    { name: "Python, NumPy & Pandas", level: 94, icon: Code2, color: "text-blue-400" },
    { name: "Deep Learning & TensorFlow", level: 88, icon: Cpu, color: "text-amber-400" },
  ];
  ...
  const softSkills = [
    ...
    { name: "Adaptability", icon: Workflow, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "Communication", icon: HeartHandshake, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "Continuous Learning", icon: Rocket, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
  ];
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                <strong className="text-foreground font-bold text-sm block mb-0.5">
                  Continuous Learner & Generative AI Builder
                </strong>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Continuously learning emerging tools, LLM architectures, and cutting-edge NLP techniques to build real-world AI applications.
                </p>
              </div>
            </div>
          </div>
