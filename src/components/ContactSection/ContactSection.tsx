          ...
          <div className="flex-1 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Seeking an entry-level opportunity to apply and grow my skills in a real-world generative AI environment. 
                Whether you have an opportunity, inquiry, or project to discuss, feel free to reach out!
              </p>
            </div>

            <div className="space-y-6">
              <a href="mailto:tamizhmaran63@gmail.com" className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group">
                ...
                <span className="font-medium">tamizhmaran63@gmail.com</span>
              </a>
              <a href="tel:+916383971705" className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group">
                <div className="w-12 h-12 rounded-full glass-panel flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Phone className="w-5 h-5" />
                </div>
                <span className="font-medium">+91 6383971705</span>
              </a>
